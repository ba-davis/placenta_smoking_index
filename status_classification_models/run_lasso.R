...
# Source functions
### change this to lasso specific functions script
#source("/home/groups/hoolock2/u0/bd/Projects/lyndsey_shorey_project/lasso_regression/lasso_specific_functions.R")
...
mod_spec <- logistic_reg(mode="classification", penalty=penalty_val, mixture=1) %>%
    set_engine("glmnet")
