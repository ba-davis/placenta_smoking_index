...
plot_psi_v_cot(infile = "../psi_scores/model1.psi_vcsip.txt",
  pd, cotinine_dat, mypath,
  mod_num = "model1_EPIC",
  y_rho = -0.8,
  y_pval = -0.9)

plot_psi_v_cot(infile = "../psi_scores/model2.psi_vcsip.txt",
  pd, cotinine_dat, mypath,
  mod_num = "model2_450k",
  y_rho = -0.9,
  y_pval = -1)

plot_psi_v_cot(infile = "../psi_scores/model3.psi_vcsip.txt",
  pd, cotinine_dat, mypath,
  mod_num = "model3_PACE",
  y_rho = -2,
  y_pval = -2.1)
