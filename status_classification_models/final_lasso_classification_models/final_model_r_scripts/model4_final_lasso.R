...
######################################
# Model 4: LASSO Logistic Regression #
######################################
...
penalty_val <- 3.35981828628379E-10
nCpG_val <- 98
...
saveRDS(lasso_fit, "model4_lasso_fit.RDS")
...
mean_sd_tab <- extract_mean_sd_table(df_clean,
  nonzero_imp_vars,
  export = TRUE,
  outfile = "model4.mean_sd_table.txt")
