...
dir <- paste0("/home/groups/hoolock2/u0/bd/Projects/",
  "lyndsey_shorey_project/classification_models/450k_array_data/lasso/try1")
...
write.table(metric_df,
  "450k_lasso_hyper_tuning_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# path to folder containing performance metrics txt files
dir <- paste0("/home/groups/hoolock2/u0/bd/Projects/",
  "lyndsey_shorey_project/classification_models/450k_array_data/",
  "elastic_net/try1")
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_elasticnet_hyper_tuning_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_elasticnet_hyper_tuning_accuracy_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_elasticnet_hyper_tuning_rocauc_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_rf1_hyper_tuning_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_rf2_hyper_tuning_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_gbm_hyper_tuning_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_gbm_hyper_tuning_accuracy_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
# export the cv hyper tuning performance metrics
write.table(metric_df,
  "450k_gbm_hyper_tuning_rocauc_metrics.txt",
  sep="\t",
  col.names=T,
  row.names=F,
  quote=F)
...
write_xlsx(perfs, "450k_hyperparam_res.xlsx")
