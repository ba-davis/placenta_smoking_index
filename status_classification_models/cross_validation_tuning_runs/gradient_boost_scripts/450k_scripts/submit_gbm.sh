...
#SBATCH -o gbm_%A_%a.out                # Standard output
#SBATCH -e gbm_%A_%a.err                # Standard error
#SBATCH --array=1-26                  # sets number of jobs in array
...
#Rscript make_hyperparams_gbm.R
# arguments file
dir=$(pwd)
args_file=$dir/gbm_hyperparam_args_file2
...
Rscript run_gbm.R -a $H1 -b $H2 -c $H3 -s $SEED
